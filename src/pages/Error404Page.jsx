...
const Error404Page = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 left-20 w-32 h-32 bg-gradient-to-br from-green-200 to-emerald-200 rounded-full opacity-20 animate-bounce" style={{ animationDuration: '6s' }} />
        <div className="absolute top-40 right-32 w-24 h-24 bg-gradient-to-br from-emerald-200 to-green-300 rounded-lg opacity-20 animate-pulse" style={{ animationDuration: '4s' }} />
        <div className="absolute bottom-32 left-40 w-20 h-20 bg-gradient-to-br from-green-300 to-emerald-300 rounded-full opacity-20 animate-ping" style={{ animationDuration: '8s' }} />
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <div className={`mb-8 transition-all duration-1000 delay-300 ${
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            It seems like the page you're looking for has wandered off into the digital wilderness. 
        ...
        <div className={`flex justify-center transition-all duration-1000 delay-700 ${
          ...
          <button className="group relative bg-gradient-to-r from-green-600 to-emerald-600 text-white px-12 py-5 rounded-full font-semibold text-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-500 transform hover:scale-110 shadow-2xl hover:shadow-green-200 flex items-center overflow-hidden">
            {/* Button shine effect */}
